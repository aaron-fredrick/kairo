...
from app_backend.auth.jwt import get_current_user_payload
...
from app_backend.services.thumbnail_service import THUMBNAIL_SIZES
from app_backend.storage.paths import pfp_path, temp_pfp_path, temp_upload_path, thumbnail_path
