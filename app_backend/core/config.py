...
class Settings(BaseSettings):
    ...
    # All artifacts use StorageProvider paths — see app_backend.storage.paths.
    @property
    ...
    # Register service (distributed deployments)
    ...
    REGISTER_URL: str = os.getenv("REGISTER_URL", "http://127.0.0.1:8100")
    ...
    REGISTER_HEARTBEAT_INTERVAL: int = int(os.getenv("REGISTER_HEARTBEAT_INTERVAL", "15"))
