...
from src.backend.auth.jwt import decode_access_token
...
from src.backend.ws.connection_manager import manager
...
async def websocket_endpoint(
    ...
    try:
        while True:
            ...
            if content or incoming_attachments:
                from src.backend.workers.thumbnail import thumbnail_queue
