...
from src.backend.core.middleware import IPAccessMiddleware
from src.backend.db.database import engine, AsyncSessionLocal
from src.backend.db.redis import redis_manager
from src.backend.services.admin_service import admin_service
from src.backend.storage.backends import storage_backend
from src.backend.workers.thumbnail import run_thumbnail_worker
from src.backend.workers.broadcast import run_broadcast_worker
from src.backend.ws.router import router as ws_router
from src.backend.api.auth import router as auth_router
from src.backend.clients.register_client import register_client
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("src.backend.main:app", host="127.0.0.1", port=8000, reload=True, proxy_headers=True)
