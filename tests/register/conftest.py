...
from src.register.config import RegisterSettings
from src.register.container import build_coordinator, reset_coordinator
...
def register_client(tmp_path):
    ...
    import src.register.config as register_config
    import src.register.container as container

    register_config.settings = cfg
    container._coordinator = build_coordinator(cfg)
    from src.register.main import app
