...
from src.backend.storage.backends import LocalStorage
from src.backend.workers.thumbnail import ThumbnailJob, _process_job
...
async def test_process_thumbnail_job(storage_provider):
    ...
    from src.backend.storage.blob_manager import blob_manager
