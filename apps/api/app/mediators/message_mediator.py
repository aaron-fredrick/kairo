...
class MessageMediator:
    ...
    async def get_message(self, message_id: int) -> Optional[tuple[Message, List[Attachment]]]:
        return await self.message_service.get_message_with_attachments(message_id)
